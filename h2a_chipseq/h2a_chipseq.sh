~/myPrograms/sra-tools/sratoolkit.2.9.0-centos_linux64/bin/fastq-dump --split-files --gzip -Z SRR9102954 > H2A.Z1_rep1_U2OS_SRR9102954.fastq 
~/myPrograms/sra-tools/sratoolkit.2.9.0-centos_linux64/bin/fastq-dump --split-files --gzip -Z SRR9102955 > H2A.Z2_rep1_U2OS_SRR9102955.fastq 
~/myPrograms/sra-tools/sratoolkit.2.9.0-centos_linux64/bin/fastq-dump --split-files --gzip -Z SRR9102956 > H2A.Z1_rep2_U2OS_SRR9102956.fastq 
~/myPrograms/sra-tools/sratoolkit.2.9.0-centos_linux64/bin/fastq-dump --split-files --gzip -Z SRR9102957 > H2A.Z2_rep2_U2OS_SRR9102957.fastq 
############
