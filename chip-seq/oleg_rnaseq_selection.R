...
write.table(tss_nt,"oleg_downregulated_tss.bed",quote=FALSE,col.names=FALSE,row.names=FALSE)
...
write.table(tss_h2afv,"oleg_upregulated_tss.bed",quote=FALSE,col.names=FALSE,row.names=FALSE)
##
