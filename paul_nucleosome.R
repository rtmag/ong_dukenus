...
objs <- splitBam(bamfile[i], tags=tags, outPath=outPath,
...
plot_name = paste( "paul_bam", "/", bamfile.labels[i],"/",bamfile.labels[i],"_heatmap.pdf", sep="")
pdf(plot_name)
featureAlignedHeatmap(sigs.log2, reCenterPeaks(TSS, width=ups+dws),
                      zeroAt=.5, n.tile=NTILE)
dev.off()
  
plot_name = paste( "paul_bam", "/", bamfile.labels[i],"/",bamfile.labels[i],"_distribution.pdf", sep="")
pdf(plot_name)
